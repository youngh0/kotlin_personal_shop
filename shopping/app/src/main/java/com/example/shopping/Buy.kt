    ...
    override fun onCreate(savedInstanceState: Bundle?) {
            ...
            .addOnSuccessListener { document ->
                if (document != null) {
                    ...
                    if(document.data?.get("banana").toString() != "null"){
                        ...
                        banana_line.visibility = View.GONE
                    }
                    if(document.data?.get("apple").toString() != "null"){
                        ...
                        apple_line.visibility = View.GONE
                    }
                    if(document.data?.get("watermelon").toString() != "null"){
                        ...
                        watermelon.visibility = View.GONE
                        wm_line.visibility = View.GONE
                    }
        ...
        finally_buy.setOnClickListener {
            ...
            if (validate()){
                ...
                Toast.makeText(this,"구매 완료! 구매한 품목들은 장바구니에서 삭제 됩니다.", Toast.LENGTH_SHORT).show()
